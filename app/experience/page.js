...
export default function ExperiencePage() {
  ...
  return (
    <div className="p-8 flex flex-col gap-8 bg-[#0c0c0e] min-h-screen">
      <header className="border-b border-white/5 pb-6">
        <h1 className="text-4xl font-black text-slate-100 tracking-tighter">CUSTOMER EXPERIENCE</h1>
      ...
      <section className="bg-[#131316] p-6 rounded-xl border border-white/5 shadow-2xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-[#131316] p-6 rounded-xl border border-white/5 flex flex-col min-h-[500px]">
          <h2 className="text-sm font-black text-slate-400 mb-6 flex items-center gap-3">
        ...
        <div className="bg-[#131316] p-6 rounded-xl border border-white/5 opacity-60">
          <h2 className="text-sm font-black text-slate-400 mb-6 uppercase">03. Radar chart đã chuyển sang Preview</h2>
      ...
      <section className="bg-[#131316] p-6 rounded-xl border border-white/5 opacity-30">
